<template>
  ...
  <div class="popup" :class="{ 'hide-popup': isPopupHidden }">
    <div class="popup-content">
      <div class="popup-close">
        <i class='bx bx-x' @click="hidePopup"></i>
      </div>
      <div class="popup-left">
        <div class="popup-img-container">
          <img class="popup-img" src="../assets/images/popup.jpg" alt="popup">
        </div>
      </div>
